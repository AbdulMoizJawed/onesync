...
import { searchMusic } from '@/lib/combined-music-api'
import { hasRealApiKey as checkApiKey } from '@/lib/env-config'
...
export default function SpotOnTrackSearch() {
  ...
  const hasRealApiKey = checkApiKey('SPOTONTRACK_API_KEY')
      ...
      <CardContent className="space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div>
            ...
            <Select value={searchType} onValueChange={(value) => setSearchType(value as "artist" | "track")}>
