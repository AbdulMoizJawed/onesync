...
import { Send, Search, MessageSquare, User, Image as ImageIcon, X, Paperclip } from "lucide-react"
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-hidden bg-gray-950">
            <div className="h-full flex">
              {/* Conversations List */}
              <div className="w-full md:w-80 lg:w-96 border-r border-gray-800 flex flex-col bg-gray-900/50">
                    ...
                    <div className="p-4 border-b border-gray-800 flex items-center gap-3 bg-gray-900/50">
                      ...
                      <div className="flex-1">
                        <Link href={`/profile/${selectedConversation.username || selectedConversation.id}`}>
                          <h2 className="font-semibold text-white hover:text-purple-400 transition-colors">
                      ...
                      <div className="max-w-4xl mx-auto">
                        ...
                        >
                          <Textarea
                            ...
                            className="flex-1 bg-gray-800 border-gray-700 text-white resize-none min-h-[60px] max-h-[120px]"
                            onKeyDown={(e) => {
